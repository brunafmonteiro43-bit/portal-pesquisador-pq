...
export function InstitutionalFooter() {
  return (
    <footer className="mt-16 bg-[#252d30] text-white">
      <div className="border-b border-white/10 bg-[#2d3639]">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 md:grid-cols-[1.25fr_0.9fr_1fr] lg:grid-cols-[1.35fr_0.8fr_1.05fr] lg:items-center">
          <div>
            <div className="flex flex-wrap items-center gap-4 rounded-2xl border border-white/10 bg-white/[0.04] p-4">
              <Link href="https://www.unicamp.br/" aria-label="Acessar site da UNICAMP">
                <Image src="/assets/logo-unicamp.png" alt="UNICAMP" width={82} height={82} className="h-14 w-auto object-contain" />
              </Link>
              <Link href="https://www.cocen.unicamp.br/" aria-label="Acessar site da COCEN">
                <Image src="/assets/logo-cocen.jpg" alt="COCEN" width={220} height={66} className="h-12 w-auto rounded-md bg-white object-contain p-1" />
              </Link>
              <div className="min-w-[13rem] border-l-4 border-accent pl-4">
                <h2 className="text-2xl font-black leading-tight">Portal do Pesquisador</h2>
      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 md:grid-cols-2 lg:grid-cols-[1.35fr_0.8fr_0.8fr]">
        <div>
